...
public:
    ...
    virtual bool BuildToolBar(wxToolBar* toolBar) { (void)toolBar; return false; }
    virtual void BuildMenu(wxMenuBar* menuBar) { (void)menuBar; }
    virtual void BuildModuleMenu(const int type, wxMenu* menu) { (void)type; (void)menu; }
    virtual cbConfigurationPanel* GetConfigurationPanel(wxWindow* parent) { (void)parent; return nullptr; }
};
